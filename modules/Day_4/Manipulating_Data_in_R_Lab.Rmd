...
6\. Filter the "Entity" column from the data you just made (vacc_long) so it only includes values in the following list: "Maryland","Virginia","Florida","Massachusetts", "United States". **Hint**: use `filter` and `%in%`.
