...
- [RStudio & Reproducibility Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-1.pdf)
- [Basic R & Data Input/Output Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-2.pdf)
- [Data Subsetting  Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-3.pdf)
- [Data Summarization & Data Classes Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-4.pdf)
- [Data Cleaning Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-5.pdf)
- [Data Manipulation & Data Visualization `esquisse` Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-6.pdf)
- [Data Visualization `ggplot2` & Factors Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-7.pdf)
- [Statistics Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-8.pdf)
- [Functions Cheatsheet](https://jhudatascience.org/intro_to_r/modules/cheatsheets/Day-9.pdf)
...
- [Guide on when to use quotes or backticks](https://jhudatascience.org/intro_to_r/quotes_vs_backticks.html)
...
- [Building up a `ggplot2` figure](https://hopstat.wordpress.com/2016/02/18/how-i-build-up-a-ggplot2-figure/)  (guide to making plots)
- Content for similar topics as this workshop can also be found on this [Leanpub course](https://leanpub.com/advstatcomp).

**Interested in Reproducibility?**

Check out [Candace Savonen's](https://www.cansavvy.com/) courses:
...
## Videos of Online Lectures for our [Johns Hopkins](https://publichealth.jhu.edu/) course
***
